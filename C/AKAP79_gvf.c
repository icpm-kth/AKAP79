...
int AKAP79_default(double t, void *par)
{
	...
	p_[_k5_1] = 4.56765525529777;
	p_[_k1_2] = 0.7363866194561;
	p_[_k3_2] = 0.103933916507664;
	p_[_k2_3] = 0.164145836393724;
	p_[_k3_4] = 0.0610537900055097;
	p_[_k4_3] = 0.161378942409605;
	p_[_k4_1] = 0.241714016897036;
	p_[_k1_4] = 0.0753960796011278;
	p_[_k8_7] = 0.161378942409605;
	p_[_k7_8] = 0.0610537900055097;
	p_[_k5_6] = 0.737123374391628;
	p_[_k6_5] = 1.16183424272828;
	p_[_k8_5] = 1.37988477595725;
	p_[_k7_6] = 0.591555364366815;
	p_[_k6_7] = 0.174644988966811;
	p_[_k6_2] = 4.56765525529777;
	p_[_k5_8] = 0.029510769926749;
	p_[_AKAPoff_1] = 1.51437074069205;
	p_[_AKAPoff_3] = 3.6729677995469;
	p_[_AKAPon_1] = 0.706805328257749;
	p_[_AKAPon_3] = 1.35120934153802;
	p_[_kf_C_AKAR4] = 0.174644988966811;
	p_[_kb_C_AKAR4] = 0.377192353563157;
	p_[_kcat_AKARp] = 2.74285678634492;
	p_[_kmOFF] = 2;
	p_[_KD_T] = -0.155;
	return GSL_SUCCESS;
}
