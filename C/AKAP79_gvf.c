...
enum param { _k5_1, _k1_2, _k3_2, _k2_3, _k3_4, _k4_3, _k4_1, _k1_4, _k8_7, _k7_8, _k5_6, _k6_5, _k8_5, _k7_6, _k6_7, _k6_2, _k5_8, _k3p_7off, _k4p_8off, _k3p_3off, _k4p_4off, _k3p_7on, _k4p_8on, _k3p_3on, _k4p_4on, _kf_C_AKAR4, _kb_C_AKAR4, _kcat_AKARp, _km3OFF, _km4OFF, _km3ON, _km4ON, _k2_1, _b_AKAP, _AKAR4_ConservedConst, _CaN_ConservedConst, _Rii_C_ConservedConst, _cAMP_ConservedConst, _Rii_ConservedConst, numParam };
...
/* 	expressions   */
	...
	/*[ 2, 3]*/  jac_[25] = k1_2*RiiP_C+k2_1-k5_1;
...
/* 	expressions   */
	...
	/*[ 2, 1]*/  jacp_[79] = -RiiP_C*(cAMP_ConservedConst-(RiiP_cAMP+RiiP_C_cAMP+Rii_cAMP+Rii_C_cAMP+RiiP_cAMP_CaN));
	/*[ 2, 6]*/  jacp_[84] = RiiP*C;
	/*[ 2, 7]*/  jacp_[85] = -RiiP_C;
	/*[ 2,32]*/  jacp_[110] = RiiP_C_cAMP;
	/*[ 2,36]*/  jacp_[114] = k5_1;
	/*[ 2,37]*/  jacp_[115] = -k1_2*RiiP_C;
	/*[ 3, 1]*/  jacp_[118] = RiiP_C*(cAMP_ConservedConst-(RiiP_cAMP+RiiP_C_cAMP+Rii_cAMP+Rii_C_cAMP+RiiP_cAMP_CaN));
	/*[ 3, 2]*/  jacp_[119] = RiiP_cAMP*C;
	/*[ 3, 3]*/  jacp_[120] = -RiiP_C_cAMP;
	/*[ 3,15]*/  jacp_[132] = Rii_C_cAMP;
	/*[ 3,32]*/  jacp_[149] = -RiiP_C_cAMP;
...
/* 	expressions   */
	...
	double reaction_1 = kf_C_AKAR4*C*AKAR4 - kb_C_AKAR4*AKAR4_C;
	double reaction_2 = kcat_AKARp*AKAR4_C;
	memset(funcJacp_,0,sizeof(double)*468); /* initialize with 0.0 */
	/*[ 1, 6]*/  funcJacp_[45] = -RiiP*C;
	/*[ 1, 7]*/  funcJacp_[46] = RiiP_C;
	/*[ 2, 1]*/  funcJacp_[79] = RiiP_C*(cAMP_ConservedConst-(RiiP_cAMP+RiiP_C_cAMP+Rii_cAMP+Rii_C_cAMP+RiiP_cAMP_CaN));
	/*[ 2,32]*/  funcJacp_[110] = -RiiP_C_cAMP;
	/*[ 2,37]*/  funcJacp_[115] = k1_2*RiiP_C;
	/*[ 3, 4]*/  funcJacp_[121] = -RiiP_cAMP;
	/*[ 3, 5]*/  funcJacp_[122] = (cAMP_ConservedConst-(RiiP_cAMP+RiiP_C_cAMP+Rii_cAMP+Rii_C_cAMP+RiiP_cAMP_CaN))*RiiP;
	/*[ 3,37]*/  funcJacp_[154] = k4_3*RiiP;
	/*[ 4, 2]*/  funcJacp_[158] = -RiiP_cAMP*C;
	/*[ 4, 3]*/  funcJacp_[159] = RiiP_C_cAMP;
	/*[ 5, 8]*/  funcJacp_[203] = -(cAMP_ConservedConst-(RiiP_cAMP+RiiP_C_cAMP+Rii_cAMP+Rii_C_cAMP+RiiP_cAMP_CaN))*(Rii_ConservedConst-(RiiP+RiiP_cAMP+Rii_cAMP+RiiP_CaN+RiiP_cAMP_CaN-C-AKAR4_C));
	/*[ 5, 9]*/  funcJacp_[204] = Rii_cAMP;
	/*[ 5,37]*/  funcJacp_[232] = -k8_7*(Rii_ConservedConst-(RiiP+RiiP_cAMP+Rii_cAMP+RiiP_CaN+RiiP_cAMP_CaN-C-AKAR4_C));
	/*[ 5,38]*/  funcJacp_[233] = -k8_7*(cAMP_ConservedConst-(RiiP_cAMP+RiiP_C_cAMP+Rii_cAMP+Rii_C_cAMP+RiiP_cAMP_CaN));
	/*[ 6,10]*/  funcJacp_[244] = (Rii_C_ConservedConst-(RiiP_C+RiiP_C_cAMP+C+Rii_C_cAMP+AKAR4_C))*(cAMP_ConservedConst-(RiiP_cAMP+RiiP_C_cAMP+Rii_cAMP+Rii_C_cAMP+RiiP_cAMP_CaN));
	/*[ 6,11]*/  funcJacp_[245] = -Rii_C_cAMP;
	/*[ 6,36]*/  funcJacp_[270] = k5_6*(cAMP_ConservedConst-(RiiP_cAMP+RiiP_C_cAMP+Rii_cAMP+Rii_C_cAMP+RiiP_cAMP_CaN));
	/*[ 6,37]*/  funcJacp_[271] = k5_6*(Rii_C_ConservedConst-(RiiP_C+RiiP_C_cAMP+C+Rii_C_cAMP+AKAR4_C));
	/*[ 7,13]*/  funcJacp_[286] = Rii_cAMP*C;
	/*[ 7,14]*/  funcJacp_[287] = -Rii_C_cAMP;
	/*[ 8,12]*/  funcJacp_[324] = -(Rii_ConservedConst-(RiiP+RiiP_cAMP+Rii_cAMP+RiiP_CaN+RiiP_cAMP_CaN-C-AKAR4_C))*C;
	/*[ 8,16]*/  funcJacp_[328] = Rii_C_ConservedConst-(RiiP_C+RiiP_C_cAMP+C+Rii_C_cAMP+AKAR4_C);
	/*[ 8,36]*/  funcJacp_[348] = k5_8;
	/*[ 8,38]*/  funcJacp_[350] = -k8_5*C;
	/*[ 9,18]*/  funcJacp_[369] = ((b_AKAP*(1-b_AKAP))/km4ON+gsl_pow_2(1-b_AKAP)/km4OFF)*RiiP*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN));
	/*[ 9,20]*/  funcJacp_[371] = ((b_AKAP*(1-b_AKAP))/km4ON+gsl_pow_2(1-b_AKAP)/km4OFF)*RiiP*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))-(1-b_AKAP)*RiiP_CaN;
	/*[ 9,22]*/  funcJacp_[373] = (gsl_pow_2(b_AKAP)/km4ON+((1-b_AKAP)*b_AKAP)/km4OFF)*RiiP*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN));
	/*[ 9,24]*/  funcJacp_[375] = (gsl_pow_2(b_AKAP)/km4ON+((1-b_AKAP)*b_AKAP)/km4OFF)*RiiP*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))-b_AKAP*RiiP_CaN;
	/*[ 9,29]*/  funcJacp_[380] = (-RiiP*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*(1-b_AKAP)*(b_AKAP*k4p_4on+(1-b_AKAP)*k4p_4off+b_AKAP*k4p_8on+(1-b_AKAP)*k4p_8off))/gsl_pow_2(km4OFF);
	/*[ 9,31]*/  funcJacp_[382] = (-RiiP*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*b_AKAP*(b_AKAP*k4p_4on+(1-b_AKAP)*k4p_4off+b_AKAP*k4p_8on+(1-b_AKAP)*k4p_8off))/gsl_pow_2(km4ON);
	/*[ 9,33]*/  funcJacp_[384] = ((b_AKAP*(k4p_4on-k4p_4off+k4p_8on-k4p_8off)+b_AKAP*k4p_4on+(1-b_AKAP)*k4p_4off+b_AKAP*k4p_8on+(1-b_AKAP)*k4p_8off)/km4ON+((1-b_AKAP)*(k4p_4on-k4p_4off+k4p_8on-k4p_8off)-(b_AKAP*k4p_4on+(1-b_AKAP)*k4p_4off+b_AKAP*k4p_8on+(1-b_AKAP)*k4p_8off))/km4OFF)*RiiP*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))-(k4p_4on-k4p_4off)*RiiP_CaN;
	/*[ 9,35]*/  funcJacp_[386] = ((b_AKAP*(b_AKAP*k4p_4on+(1-b_AKAP)*k4p_4off+b_AKAP*k4p_8on+(1-b_AKAP)*k4p_8off))/km4ON+((1-b_AKAP)*(b_AKAP*k4p_4on+(1-b_AKAP)*k4p_4off+b_AKAP*k4p_8on+(1-b_AKAP)*k4p_8off))/km4OFF)*RiiP;
	/*[10,17]*/  funcJacp_[407] = ((b_AKAP*(1-b_AKAP))/km3ON+gsl_pow_2(1-b_AKAP)/km3OFF)*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*RiiP_cAMP;
	/*[10,19]*/  funcJacp_[409] = ((b_AKAP*(1-b_AKAP))/km3ON+gsl_pow_2(1-b_AKAP)/km3OFF)*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*RiiP_cAMP-(1-b_AKAP)*RiiP_cAMP_CaN;
	/*[10,21]*/  funcJacp_[411] = (gsl_pow_2(b_AKAP)/km3ON+((1-b_AKAP)*b_AKAP)/km3OFF)*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*RiiP_cAMP;
	/*[10,23]*/  funcJacp_[413] = (gsl_pow_2(b_AKAP)/km3ON+((1-b_AKAP)*b_AKAP)/km3OFF)*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*RiiP_cAMP-b_AKAP*RiiP_cAMP_CaN;
	/*[10,28]*/  funcJacp_[418] = (-(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*RiiP_cAMP*(1-b_AKAP)*(b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off))/gsl_pow_2(km3OFF);
	/*[10,30]*/  funcJacp_[420] = (-(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*RiiP_cAMP*b_AKAP*(b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off))/gsl_pow_2(km3ON);
	/*[10,33]*/  funcJacp_[423] = ((b_AKAP*(k3p_3on-k3p_3off+k3p_7on-k3p_7off)+b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off)/km3ON+((1-b_AKAP)*(k3p_3on-k3p_3off+k3p_7on-k3p_7off)-(b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off))/km3OFF)*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*RiiP_cAMP-(k3p_3on-k3p_3off)*RiiP_cAMP_CaN;
	/*[10,35]*/  funcJacp_[425] = ((b_AKAP*(b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off))/km3ON+((1-b_AKAP)*(b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off))/km3OFF)*RiiP_cAMP;
	/*[11,25]*/  funcJacp_[454] = C*(AKAR4_ConservedConst-(AKAR4_C+AKAR4p));
	/*[11,26]*/  funcJacp_[455] = -AKAR4_C;
	/*[11,34]*/  funcJacp_[463] = kf_C_AKAR4*C;
	return GSL_SUCCESS;
}
