...
enum param { _k5_1, _k1_2, _k3_2, _k2_3, _k3_4, _k4_3, _k4_1, _k8_7, _k7_8, _k5_6, _k6_5, _k8_5, _k7_6, _k6_7, _k6_2, _k3p_7off, _k4p_8off, _k3p_3off, _k4p_4off, _k3p_7on, _k4p_8on, _k3p_3on, _k4p_4on, _kf_C_AKAR4, _kb_C_AKAR4, _kcat_AKARp, _km3OFF, _km4OFF, _km3ON, _km4ON, _KD_T, _b_AKAP, _AKAR4_ConservedConst, _CaN_ConservedConst, _Rii_C_ConservedConst, _cAMP_ConservedConst, _Rii_ConservedConst, numParam };
...
/* 	parameter values   */
	...
	double k8_7 = p_[_k8_7];                                            /* [  7] */
	double k7_8 = p_[_k7_8];                                            /* [  8] */
	double k5_6 = p_[_k5_6];                                            /* [  9] */
	double k6_5 = p_[_k6_5];                                            /* [ 10] */
	double k8_5 = p_[_k8_5];                                            /* [ 11] */
	double k7_6 = p_[_k7_6];                                            /* [ 12] */
	double k6_7 = p_[_k6_7];                                            /* [ 13] */
	double k6_2 = p_[_k6_2];                                            /* [ 14] */
	double k3p_7off = p_[_k3p_7off];                                    /* [ 15] */
	double k4p_8off = p_[_k4p_8off];                                    /* [ 16] */
	double k3p_3off = p_[_k3p_3off];                                    /* [ 17] */
	double k4p_4off = p_[_k4p_4off];                                    /* [ 18] */
	double k3p_7on = p_[_k3p_7on];                                      /* [ 19] */
	double k4p_8on = p_[_k4p_8on];                                      /* [ 20] */
	double k3p_3on = p_[_k3p_3on];                                      /* [ 21] */
	double k4p_4on = p_[_k4p_4on];                                      /* [ 22] */
	double kf_C_AKAR4 = p_[_kf_C_AKAR4];                                /* [ 23] */
	double kb_C_AKAR4 = p_[_kb_C_AKAR4];                                /* [ 24] */
	double kcat_AKARp = p_[_kcat_AKARp];                                /* [ 25] */
	double km3OFF = p_[_km3OFF];                                        /* [ 26] */
	double km4OFF = p_[_km4OFF];                                        /* [ 27] */
	double km3ON = p_[_km3ON];                                          /* [ 28] */
	double km4ON = p_[_km4ON];                                          /* [ 29] */
...
/* 	expressions   */
	...
	double k1_4 = k1_2 * k2_3 * k3_4 * k4_1 / (k4_3 * k3_2 * k2_1);
	double k5_8 = k5_6 * k6_7 * k7_8 * k8_5 / (k8_7 * k7_6 * k6_5);
...
/* 	expressions   */
	...
	/*[ 0, 2]*/  jac_[2] = (k1_2*k2_3*k3_4*k4_1)/(k4_3*k3_2*k1_2*KD_T);
	...
	/*[ 2, 2]*/  jac_[24] = -((k1_2*k2_3*k3_4*k4_1)/(k4_3*k3_2*k1_2*KD_T)+k5_1+k1_2*(cAMP_ConservedConst-(RiiP_cAMP+RiiP_C_cAMP+Rii_cAMP+Rii_C_cAMP+RiiP_cAMP_CaN)));
	...
	/*[ 4, 2]*/  jac_[46] = (k1_2*k2_3*k3_4*k4_1)/(k4_3*k3_2*k1_2*KD_T)-(k5_6*k6_7*k7_8*k8_5)/(k8_7*k7_6*k6_5);
	/*[ 4, 3]*/  jac_[47] = k2_3-(k5_6*k6_7*k7_8*k8_5)/(k8_7*k7_6*k6_5);
	/*[ 4, 4]*/  jac_[48] = -(k4_1*RiiP+k3_2*RiiP_cAMP+k7_6*Rii_cAMP+k8_5*(Rii_ConservedConst-(RiiP+RiiP_cAMP+Rii_cAMP+RiiP_CaN+RiiP_cAMP_CaN-C-AKAR4_C))+k8_5*C-(-k5_6*k6_7*k7_8*k8_5)/(k8_7*k7_6*k6_5)+kf_C_AKAR4*(AKAR4_ConservedConst-(AKAR4_C+AKAR4p)));
	/*[ 4, 5]*/  jac_[49] = k8_5*C-k7_6*C;
	/*[ 4, 6]*/  jac_[50] = k6_7-(k5_6*k6_7*k7_8*k8_5)/(k8_7*k7_6*k6_5);
	/*[ 4, 7]*/  jac_[51] = k8_5*C;
	/*[ 4, 8]*/  jac_[52] = k8_5*C;
	/*[ 4, 9]*/  jac_[53] = (-k5_6*k6_7*k7_8*k8_5)/(k8_7*k7_6*k6_5)-k8_5*C+kf_C_AKAR4*C+kb_C_AKAR4+kcat_AKARp;
...
/* 	expressions   */
	...
	/*[ 0, 1]*/  jacp_[1] = (k4_3*k3_2*k1_2*KD_T*RiiP_C*k2_3*k3_4*k4_1-RiiP_C*k1_2*k2_3*k3_4*k4_1*k4_3*k3_2*KD_T)/gsl_pow_2(k4_3*k3_2*k1_2*KD_T);
	/*[ 0, 2]*/  jacp_[2] = (-RiiP_C*k1_2*k2_3*k3_4*k4_1*k4_3*k1_2*KD_T)/gsl_pow_2(k4_3*k3_2*k1_2*KD_T);
	/*[ 0, 3]*/  jacp_[3] = (RiiP_C*k1_2*k3_4*k4_1)/(k4_3*k3_2*k1_2*KD_T);
	/*[ 0, 4]*/  jacp_[4] = (RiiP_C*k1_2*k2_3*k4_1)/(k4_3*k3_2*k1_2*KD_T)+RiiP_cAMP;
	/*[ 0, 5]*/  jacp_[5] = (-RiiP_C*k1_2*k2_3*k3_4*k4_1*k3_2*k1_2*KD_T)/gsl_pow_2(k4_3*k3_2*k1_2*KD_T)-(cAMP_ConservedConst-(RiiP_cAMP+RiiP_C_cAMP+Rii_cAMP+Rii_C_cAMP+RiiP_cAMP_CaN))*RiiP;
	/*[ 0, 6]*/  jacp_[6] = (RiiP_C*k1_2*k2_3*k3_4)/(k4_3*k3_2*k1_2*KD_T)-RiiP*C;
	/*[ 0,16]*/  jacp_[16] = -((b_AKAP*(1-b_AKAP))/km4ON+gsl_pow_2(1-b_AKAP)/km4OFF)*RiiP*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN));
	/*[ 0,18]*/  jacp_[18] = (1-b_AKAP)*RiiP_CaN-((b_AKAP*(1-b_AKAP))/km4ON+gsl_pow_2(1-b_AKAP)/km4OFF)*RiiP*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN));
	/*[ 0,20]*/  jacp_[20] = -(gsl_pow_2(b_AKAP)/km4ON+((1-b_AKAP)*b_AKAP)/km4OFF)*RiiP*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN));
	/*[ 0,22]*/  jacp_[22] = b_AKAP*RiiP_CaN-(gsl_pow_2(b_AKAP)/km4ON+((1-b_AKAP)*b_AKAP)/km4OFF)*RiiP*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN));
	/*[ 0,27]*/  jacp_[27] = ((CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*RiiP*(1-b_AKAP)*(b_AKAP*k4p_4on+(1-b_AKAP)*k4p_4off+b_AKAP*k4p_8on+(1-b_AKAP)*k4p_8off))/gsl_pow_2(km4OFF);
	/*[ 0,29]*/  jacp_[29] = ((CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*RiiP*b_AKAP*(b_AKAP*k4p_4on+(1-b_AKAP)*k4p_4off+b_AKAP*k4p_8on+(1-b_AKAP)*k4p_8off))/gsl_pow_2(km4ON);
	/*[ 0,30]*/  jacp_[30] = (-RiiP_C*k1_2*k2_3*k3_4*k4_1*k4_3*k3_2*k1_2)/gsl_pow_2(k4_3*k3_2*k1_2*KD_T);
	...
	/*[ 0,33]*/  jacp_[33] = -((b_AKAP*(b_AKAP*k4p_4on+(1-b_AKAP)*k4p_4off+b_AKAP*k4p_8on+(1-b_AKAP)*k4p_8off))/km4ON+((1-b_AKAP)*(b_AKAP*k4p_4on+(1-b_AKAP)*k4p_4off+b_AKAP*k4p_8on+(1-b_AKAP)*k4p_8off))/km4OFF)*RiiP;
	...
	/*[ 1,15]*/  jacp_[52] = -((b_AKAP*(1-b_AKAP))/km3ON+gsl_pow_2(1-b_AKAP)/km3OFF)*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*RiiP_cAMP;
	/*[ 1,17]*/  jacp_[54] = (1-b_AKAP)*RiiP_cAMP_CaN-((b_AKAP*(1-b_AKAP))/km3ON+gsl_pow_2(1-b_AKAP)/km3OFF)*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*RiiP_cAMP;
	/*[ 1,19]*/  jacp_[56] = -(gsl_pow_2(b_AKAP)/km3ON+((1-b_AKAP)*b_AKAP)/km3OFF)*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*RiiP_cAMP;
	/*[ 1,21]*/  jacp_[58] = b_AKAP*RiiP_cAMP_CaN-(gsl_pow_2(b_AKAP)/km3ON+((1-b_AKAP)*b_AKAP)/km3OFF)*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*RiiP_cAMP;
	/*[ 1,26]*/  jacp_[63] = (RiiP_cAMP*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*(1-b_AKAP)*(b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off))/gsl_pow_2(km3OFF);
	/*[ 1,28]*/  jacp_[65] = (RiiP_cAMP*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*b_AKAP*(b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off))/gsl_pow_2(km3ON);
	/*[ 1,31]*/  jacp_[68] = (k3p_3on-k3p_3off)*RiiP_cAMP_CaN-((b_AKAP*(k3p_3on-k3p_3off+k3p_7on-k3p_7off)+b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off)/km3ON+((1-b_AKAP)*(k3p_3on-k3p_3off+k3p_7on-k3p_7off)-(b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off))/km3OFF)*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*RiiP_cAMP;
	/*[ 1,33]*/  jacp_[70] = -((b_AKAP*(b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off))/km3ON+((1-b_AKAP)*(b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off))/km3OFF)*RiiP_cAMP;
	/*[ 1,35]*/  jacp_[72] = k4_3*RiiP;
	/*[ 2, 0]*/  jacp_[74] = Rii_C_ConservedConst-(RiiP_C+RiiP_C_cAMP+C+Rii_C_cAMP+AKAR4_C);
	/*[ 2, 1]*/  jacp_[75] = -((k4_3*k3_2*k1_2*KD_T*RiiP_C*k2_3*k3_4*k4_1-RiiP_C*k1_2*k2_3*k3_4*k4_1*k4_3*k3_2*KD_T)/gsl_pow_2(k4_3*k3_2*k1_2*KD_T)+RiiP_C*(cAMP_ConservedConst-(RiiP_cAMP+RiiP_C_cAMP+Rii_cAMP+Rii_C_cAMP+RiiP_cAMP_CaN))-KD_T*RiiP_C_cAMP);
	/*[ 2, 2]*/  jacp_[76] = (RiiP_C*k1_2*k2_3*k3_4*k4_1*k4_3*k1_2*KD_T)/gsl_pow_2(k4_3*k3_2*k1_2*KD_T);
	/*[ 2, 3]*/  jacp_[77] = -(RiiP_C*k1_2*k3_4*k4_1)/(k4_3*k3_2*k1_2*KD_T);
	/*[ 2, 4]*/  jacp_[78] = -(RiiP_C*k1_2*k2_3*k4_1)/(k4_3*k3_2*k1_2*KD_T);
	/*[ 2, 5]*/  jacp_[79] = (RiiP_C*k1_2*k2_3*k3_4*k4_1*k3_2*k1_2*KD_T)/gsl_pow_2(k4_3*k3_2*k1_2*KD_T);
	/*[ 2, 6]*/  jacp_[80] = RiiP*C-(RiiP_C*k1_2*k2_3*k3_4)/(k4_3*k3_2*k1_2*KD_T);
	/*[ 2,30]*/  jacp_[104] = (RiiP_C*k1_2*k2_3*k3_4*k4_1*k4_3*k3_2*k1_2)/gsl_pow_2(k4_3*k3_2*k1_2*KD_T)+k1_2*RiiP_C_cAMP;
	/*[ 2,34]*/  jacp_[108] = k5_1;
	...
	/*[ 3,14]*/  jacp_[125] = Rii_C_cAMP;
	/*[ 3,30]*/  jacp_[141] = -k1_2*RiiP_C_cAMP;
	/*[ 3,35]*/  jacp_[146] = k1_2*RiiP_C;
	/*[ 4, 1]*/  jacp_[149] = (k4_3*k3_2*k1_2*KD_T*RiiP_C*k2_3*k3_4*k4_1-RiiP_C*k1_2*k2_3*k3_4*k4_1*k4_3*k3_2*KD_T)/gsl_pow_2(k4_3*k3_2*k1_2*KD_T);
	/*[ 4, 2]*/  jacp_[150] = (-RiiP_C*k1_2*k2_3*k3_4*k4_1*k4_3*k1_2*KD_T)/gsl_pow_2(k4_3*k3_2*k1_2*KD_T)-RiiP_cAMP*C;
	/*[ 4, 3]*/  jacp_[151] = (RiiP_C*k1_2*k3_4*k4_1)/(k4_3*k3_2*k1_2*KD_T)+RiiP_C_cAMP;
	/*[ 4, 4]*/  jacp_[152] = (RiiP_C*k1_2*k2_3*k4_1)/(k4_3*k3_2*k1_2*KD_T);
	/*[ 4, 5]*/  jacp_[153] = (-RiiP_C*k1_2*k2_3*k3_4*k4_1*k3_2*k1_2*KD_T)/gsl_pow_2(k4_3*k3_2*k1_2*KD_T);
	/*[ 4, 6]*/  jacp_[154] = (RiiP_C*k1_2*k2_3*k3_4)/(k4_3*k3_2*k1_2*KD_T)-RiiP*C;
	/*[ 4, 7]*/  jacp_[155] = -((Rii_C_ConservedConst-(RiiP_C+RiiP_C_cAMP+C+Rii_C_cAMP+AKAR4_C))*k5_6*k6_7*k7_8*k8_5*k7_6*k6_5)/gsl_pow_2(k8_7*k7_6*k6_5);
	/*[ 4, 8]*/  jacp_[156] = ((Rii_C_ConservedConst-(RiiP_C+RiiP_C_cAMP+C+Rii_C_cAMP+AKAR4_C))*k5_6*k6_7*k8_5)/(k8_7*k7_6*k6_5);
	/*[ 4, 9]*/  jacp_[157] = ((Rii_C_ConservedConst-(RiiP_C+RiiP_C_cAMP+C+Rii_C_cAMP+AKAR4_C))*k6_7*k7_8*k8_5)/(k8_7*k7_6*k6_5);
	/*[ 4,10]*/  jacp_[158] = -((Rii_C_ConservedConst-(RiiP_C+RiiP_C_cAMP+C+Rii_C_cAMP+AKAR4_C))*k5_6*k6_7*k7_8*k8_5*k8_7*k7_6)/gsl_pow_2(k8_7*k7_6*k6_5);
	/*[ 4,11]*/  jacp_[159] = ((Rii_C_ConservedConst-(RiiP_C+RiiP_C_cAMP+C+Rii_C_cAMP+AKAR4_C))*k5_6*k6_7*k7_8)/(k8_7*k7_6*k6_5)-(Rii_ConservedConst-(RiiP+RiiP_cAMP+Rii_cAMP+RiiP_CaN+RiiP_cAMP_CaN-C-AKAR4_C))*C;
	/*[ 4,12]*/  jacp_[160] = -(Rii_cAMP*C+((Rii_C_ConservedConst-(RiiP_C+RiiP_C_cAMP+C+Rii_C_cAMP+AKAR4_C))*k5_6*k6_7*k7_8*k8_5*k8_7*k6_5)/gsl_pow_2(k8_7*k7_6*k6_5));
	/*[ 4,13]*/  jacp_[161] = Rii_C_cAMP+((Rii_C_ConservedConst-(RiiP_C+RiiP_C_cAMP+C+Rii_C_cAMP+AKAR4_C))*k5_6*k7_8*k8_5)/(k8_7*k7_6*k6_5);
	/*[ 4,23]*/  jacp_[171] = -C*(AKAR4_ConservedConst-(AKAR4_C+AKAR4p));
	/*[ 4,24]*/  jacp_[172] = AKAR4_C;
	/*[ 4,25]*/  jacp_[173] = AKAR4_C;
	/*[ 4,30]*/  jacp_[178] = (-RiiP_C*k1_2*k2_3*k3_4*k4_1*k4_3*k3_2*k1_2)/gsl_pow_2(k4_3*k3_2*k1_2*KD_T);
	/*[ 4,32]*/  jacp_[180] = -kf_C_AKAR4*C;
	/*[ 4,34]*/  jacp_[182] = (k5_6*k6_7*k7_8*k8_5)/(k8_7*k7_6*k6_5);
	/*[ 4,36]*/  jacp_[184] = -k8_5*C;
	/*[ 5, 7]*/  jacp_[192] = (cAMP_ConservedConst-(RiiP_cAMP+RiiP_C_cAMP+Rii_cAMP+Rii_C_cAMP+RiiP_cAMP_CaN))*(Rii_ConservedConst-(RiiP+RiiP_cAMP+Rii_cAMP+RiiP_CaN+RiiP_cAMP_CaN-C-AKAR4_C));
	/*[ 5, 8]*/  jacp_[193] = -Rii_cAMP;
	/*[ 5,12]*/  jacp_[197] = -Rii_cAMP*C;
	/*[ 5,13]*/  jacp_[198] = Rii_C_cAMP;
	/*[ 5,15]*/  jacp_[200] = (1-b_AKAP)*RiiP_cAMP_CaN;
	/*[ 5,19]*/  jacp_[204] = b_AKAP*RiiP_cAMP_CaN;
	...
	/*[ 6, 9]*/  jacp_[231] = (Rii_C_ConservedConst-(RiiP_C+RiiP_C_cAMP+C+Rii_C_cAMP+AKAR4_C))*(cAMP_ConservedConst-(RiiP_cAMP+RiiP_C_cAMP+Rii_cAMP+Rii_C_cAMP+RiiP_cAMP_CaN));
	/*[ 6,10]*/  jacp_[232] = -Rii_C_cAMP;
	/*[ 6,12]*/  jacp_[234] = Rii_cAMP*C;
	/*[ 6,13]*/  jacp_[235] = -Rii_C_cAMP;
	...
	/*[ 7,16]*/  jacp_[275] = ((b_AKAP*(1-b_AKAP))/km4ON+gsl_pow_2(1-b_AKAP)/km4OFF)*RiiP*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))-(1-b_AKAP)*RiiP_CaN;
	/*[ 7,18]*/  jacp_[277] = ((b_AKAP*(1-b_AKAP))/km4ON+gsl_pow_2(1-b_AKAP)/km4OFF)*RiiP*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))-(1-b_AKAP)*RiiP_CaN;
	/*[ 7,20]*/  jacp_[279] = (gsl_pow_2(b_AKAP)/km4ON+((1-b_AKAP)*b_AKAP)/km4OFF)*RiiP*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))-b_AKAP*RiiP_CaN;
	/*[ 7,22]*/  jacp_[281] = (gsl_pow_2(b_AKAP)/km4ON+((1-b_AKAP)*b_AKAP)/km4OFF)*RiiP*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))-b_AKAP*RiiP_CaN;
	/*[ 7,27]*/  jacp_[286] = (-(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*RiiP*(1-b_AKAP)*(b_AKAP*k4p_4on+(1-b_AKAP)*k4p_4off+b_AKAP*k4p_8on+(1-b_AKAP)*k4p_8off))/gsl_pow_2(km4OFF);
	/*[ 7,29]*/  jacp_[288] = (-(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*RiiP*b_AKAP*(b_AKAP*k4p_4on+(1-b_AKAP)*k4p_4off+b_AKAP*k4p_8on+(1-b_AKAP)*k4p_8off))/gsl_pow_2(km4ON);
	...
	/*[ 7,33]*/  jacp_[292] = ((b_AKAP*(b_AKAP*k4p_4on+(1-b_AKAP)*k4p_4off+b_AKAP*k4p_8on+(1-b_AKAP)*k4p_8off))/km4ON+((1-b_AKAP)*(b_AKAP*k4p_4on+(1-b_AKAP)*k4p_4off+b_AKAP*k4p_8on+(1-b_AKAP)*k4p_8off))/km4OFF)*RiiP;
	/*[ 8,15]*/  jacp_[311] = ((b_AKAP*(1-b_AKAP))/km3ON+gsl_pow_2(1-b_AKAP)/km3OFF)*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*RiiP_cAMP-(1-b_AKAP)*RiiP_cAMP_CaN;
	/*[ 8,17]*/  jacp_[313] = ((b_AKAP*(1-b_AKAP))/km3ON+gsl_pow_2(1-b_AKAP)/km3OFF)*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*RiiP_cAMP-(1-b_AKAP)*RiiP_cAMP_CaN;
	/*[ 8,19]*/  jacp_[315] = (gsl_pow_2(b_AKAP)/km3ON+((1-b_AKAP)*b_AKAP)/km3OFF)*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*RiiP_cAMP-b_AKAP*RiiP_cAMP_CaN;
	/*[ 8,21]*/  jacp_[317] = (gsl_pow_2(b_AKAP)/km3ON+((1-b_AKAP)*b_AKAP)/km3OFF)*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*RiiP_cAMP-b_AKAP*RiiP_cAMP_CaN;
	/*[ 8,26]*/  jacp_[322] = (-RiiP_cAMP*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*(1-b_AKAP)*(b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off))/gsl_pow_2(km3OFF);
	/*[ 8,28]*/  jacp_[324] = (-RiiP_cAMP*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*b_AKAP*(b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off))/gsl_pow_2(km3ON);
	/*[ 8,31]*/  jacp_[327] = ((b_AKAP*(k3p_3on-k3p_3off+k3p_7on-k3p_7off)+b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off)/km3ON+((1-b_AKAP)*(k3p_3on-k3p_3off+k3p_7on-k3p_7off)-(b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off))/km3OFF)*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*RiiP_cAMP-(k3p_3on-k3p_3off)*RiiP_cAMP_CaN-(k3p_7on-k3p_7off)*RiiP_cAMP_CaN;
	/*[ 8,33]*/  jacp_[329] = ((b_AKAP*(b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off))/km3ON+((1-b_AKAP)*(b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off))/km3OFF)*RiiP_cAMP;
	/*[ 9,23]*/  jacp_[356] = C*(AKAR4_ConservedConst-(AKAR4_C+AKAR4p));
	/*[ 9,24]*/  jacp_[357] = -AKAR4_C;
	/*[ 9,25]*/  jacp_[358] = -AKAR4_C;
	/*[ 9,32]*/  jacp_[365] = kf_C_AKAR4*C;
	/*[10,25]*/  jacp_[395] = AKAR4_C;
	return GSL_SUCCESS;
}
