...
##	expressions
	...
	jac_[1,1] <- -(k4_1*C+k4_3*(cAMP_ConservedConst-(RiiP_cAMP+RiiP_C_cAMP+Rii_cAMP+Rii_C_cAMP+RiiP_cAMP_CaN))+((b_AKAP*(b_AKAP*k4p_4on+(1-b_AKAP)*k4p_4off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off))/kmON+((1-b_AKAP)*(b_AKAP*k4p_4on+(1-b_AKAP)*k4p_4off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off))/kmOFF)*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN)))
	...
	jac_[8,1] <- ((b_AKAP*(b_AKAP*k4p_4on+(1-b_AKAP)*k4p_4off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off))/kmON+((1-b_AKAP)*(b_AKAP*k4p_4on+(1-b_AKAP)*k4p_4off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off))/kmOFF)*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))
	jac_[1,2] <- k4_3*RiiP+k3_4
	jac_[2,2] <- -(k4_3*RiiP+k3_4+k3_2*C+((b_AKAP*(b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k4p_8on+(1-b_AKAP)*k4p_8off))/kmON+((1-b_AKAP)*(b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k4p_8on+(1-b_AKAP)*k4p_8off))/kmOFF)*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN)))
	...
	jac_[9,2] <- ((b_AKAP*(b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k4p_8on+(1-b_AKAP)*k4p_8off))/kmON+((1-b_AKAP)*(b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k4p_8on+(1-b_AKAP)*k4p_8off))/kmOFF)*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))
	jac_[1,3] <- k1_4
	...
	jac_[1,8] <- ((b_AKAP*(b_AKAP*k4p_4on+(1-b_AKAP)*k4p_4off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off))/kmON+((1-b_AKAP)*(b_AKAP*k4p_4on+(1-b_AKAP)*k4p_4off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off))/kmOFF)*RiiP+b_AKAP*k4p_4on+(1-b_AKAP)*k4p_4off
	jac_[2,8] <- ((b_AKAP*(b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k4p_8on+(1-b_AKAP)*k4p_8off))/kmON+((1-b_AKAP)*(b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k4p_8on+(1-b_AKAP)*k4p_8off))/kmOFF)*RiiP_cAMP
	jac_[5,8] <- k8_5*C
	jac_[6,8] <- -k8_7*(cAMP_ConservedConst-(RiiP_cAMP+RiiP_C_cAMP+Rii_cAMP+Rii_C_cAMP+RiiP_cAMP_CaN))
	jac_[8,8] <- -(((b_AKAP*(b_AKAP*k4p_4on+(1-b_AKAP)*k4p_4off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off))/kmON+((1-b_AKAP)*(b_AKAP*k4p_4on+(1-b_AKAP)*k4p_4off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off))/kmOFF)*RiiP+b_AKAP*k4p_4on+(1-b_AKAP)*k4p_4off+b_AKAP*k4p_8on+(1-b_AKAP)*k4p_8off)
	jac_[9,8] <- -((b_AKAP*(b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k4p_8on+(1-b_AKAP)*k4p_8off))/kmON+((1-b_AKAP)*(b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k4p_8on+(1-b_AKAP)*k4p_8off))/kmOFF)*RiiP_cAMP
	jac_[1,9] <- k4_3*RiiP+((b_AKAP*(b_AKAP*k4p_4on+(1-b_AKAP)*k4p_4off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off))/kmON+((1-b_AKAP)*(b_AKAP*k4p_4on+(1-b_AKAP)*k4p_4off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off))/kmOFF)*RiiP
	jac_[2,9] <- ((b_AKAP*(b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k4p_8on+(1-b_AKAP)*k4p_8off))/kmON+((1-b_AKAP)*(b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k4p_8on+(1-b_AKAP)*k4p_8off))/kmOFF)*RiiP_cAMP+b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off-k4_3*RiiP
	...
	jac_[8,9] <- -((b_AKAP*(b_AKAP*k4p_4on+(1-b_AKAP)*k4p_4off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off))/kmON+((1-b_AKAP)*(b_AKAP*k4p_4on+(1-b_AKAP)*k4p_4off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off))/kmOFF)*RiiP
	jac_[9,9] <- -(((b_AKAP*(b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k4p_8on+(1-b_AKAP)*k4p_8off))/kmON+((1-b_AKAP)*(b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k4p_8on+(1-b_AKAP)*k4p_8off))/kmOFF)*RiiP_cAMP+b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off)
	jac_[3,10] <- -k5_1
...
##	expressions
	...
	jacp_[8,18] <- ((b_AKAP*(1-b_AKAP))/kmON+(1-b_AKAP)^2/kmOFF)*RiiP*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))
	jacp_[9,18] <- -(1-b_AKAP)*RiiP_cAMP_CaN
	jacp_[2,19] <- -((b_AKAP*(1-b_AKAP))/kmON+(1-b_AKAP)^2/kmOFF)*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*RiiP_cAMP
	jacp_[8,19] <- -(1-b_AKAP)*RiiP_CaN
	jacp_[9,19] <- ((b_AKAP*(1-b_AKAP))/kmON+(1-b_AKAP)^2/kmOFF)*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*RiiP_cAMP
	jacp_[2,20] <- (1-b_AKAP)*RiiP_cAMP_CaN-((b_AKAP*(1-b_AKAP))/kmON+(1-b_AKAP)^2/kmOFF)*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*RiiP_cAMP
	jacp_[9,20] <- ((b_AKAP*(1-b_AKAP))/kmON+(1-b_AKAP)^2/kmOFF)*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*RiiP_cAMP-(1-b_AKAP)*RiiP_cAMP_CaN
	jacp_[1,21] <- (1-b_AKAP)*RiiP_CaN-((b_AKAP*(1-b_AKAP))/kmON+(1-b_AKAP)^2/kmOFF)*RiiP*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))
	jacp_[8,21] <- ((b_AKAP*(1-b_AKAP))/kmON+(1-b_AKAP)^2/kmOFF)*RiiP*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))-(1-b_AKAP)*RiiP_CaN
	jacp_[1,22] <- -(b_AKAP^2/kmON+((1-b_AKAP)*b_AKAP)/kmOFF)*RiiP*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))
	jacp_[6,22] <- b_AKAP*RiiP_cAMP_CaN
	jacp_[8,22] <- (b_AKAP^2/kmON+((1-b_AKAP)*b_AKAP)/kmOFF)*RiiP*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))
	jacp_[9,22] <- -b_AKAP*RiiP_cAMP_CaN
	jacp_[2,23] <- -(b_AKAP^2/kmON+((1-b_AKAP)*b_AKAP)/kmOFF)*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*RiiP_cAMP
	jacp_[8,23] <- -b_AKAP*RiiP_CaN
	jacp_[9,23] <- (b_AKAP^2/kmON+((1-b_AKAP)*b_AKAP)/kmOFF)*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*RiiP_cAMP
	jacp_[2,24] <- b_AKAP*RiiP_cAMP_CaN-(b_AKAP^2/kmON+((1-b_AKAP)*b_AKAP)/kmOFF)*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*RiiP_cAMP
	jacp_[9,24] <- (b_AKAP^2/kmON+((1-b_AKAP)*b_AKAP)/kmOFF)*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*RiiP_cAMP-b_AKAP*RiiP_cAMP_CaN
	jacp_[1,25] <- b_AKAP*RiiP_CaN-(b_AKAP^2/kmON+((1-b_AKAP)*b_AKAP)/kmOFF)*RiiP*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))
	jacp_[8,25] <- (b_AKAP^2/kmON+((1-b_AKAP)*b_AKAP)/kmOFF)*RiiP*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))-b_AKAP*RiiP_CaN
	...
	jacp_[10,28] <- -AKAR4_C
	jacp_[11,28] <- AKAR4_C
	jacp_[1,29] <- ((CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*RiiP*(1-b_AKAP)*(b_AKAP*k4p_4on+(1-b_AKAP)*k4p_4off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off))/kmOFF^2
	jacp_[2,29] <- (RiiP_cAMP*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*(1-b_AKAP)*(b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k4p_8on+(1-b_AKAP)*k4p_8off))/kmOFF^2
	jacp_[8,29] <- (-(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*RiiP*(1-b_AKAP)*(b_AKAP*k4p_4on+(1-b_AKAP)*k4p_4off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off))/kmOFF^2
	jacp_[9,29] <- (-RiiP_cAMP*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*(1-b_AKAP)*(b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k4p_8on+(1-b_AKAP)*k4p_8off))/kmOFF^2
	jacp_[1,30] <- ((CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*RiiP*b_AKAP*(b_AKAP*k4p_4on+(1-b_AKAP)*k4p_4off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off))/kmON^2
	jacp_[2,30] <- (RiiP_cAMP*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*b_AKAP*(b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k4p_8on+(1-b_AKAP)*k4p_8off))/kmON^2
	jacp_[8,30] <- (-(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*RiiP*b_AKAP*(b_AKAP*k4p_4on+(1-b_AKAP)*k4p_4off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off))/kmON^2
	jacp_[9,30] <- (-RiiP_cAMP*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*b_AKAP*(b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k4p_8on+(1-b_AKAP)*k4p_8off))/kmON^2
	jacp_[3,31] <- k1_2*RiiP_C_cAMP
	...
	jacp_[9,32] <- ((b_AKAP*(k3p_3on-k3p_3off+k4p_8on-k4p_8off)+b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k4p_8on+(1-b_AKAP)*k4p_8off)/kmON+((1-b_AKAP)*(k3p_3on-k3p_3off+k4p_8on-k4p_8off)-(b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k4p_8on+(1-b_AKAP)*k4p_8off))/kmOFF)*(CaN_ConservedConst-(RiiP_CaN+RiiP_cAMP_CaN))*RiiP_cAMP-(k3p_3on-k3p_3off)*RiiP_cAMP_CaN-(k3p_7on-k3p_7off)*RiiP_cAMP_CaN
	jacp_[5,33] <- -kf_C_AKAR4*C
	jacp_[10,33] <- kf_C_AKAR4*C
	jacp_[1,34] <- -((b_AKAP*(b_AKAP*k4p_4on+(1-b_AKAP)*k4p_4off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off))/kmON+((1-b_AKAP)*(b_AKAP*k4p_4on+(1-b_AKAP)*k4p_4off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off))/kmOFF)*RiiP
	jacp_[2,34] <- -((b_AKAP*(b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k4p_8on+(1-b_AKAP)*k4p_8off))/kmON+((1-b_AKAP)*(b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k4p_8on+(1-b_AKAP)*k4p_8off))/kmOFF)*RiiP_cAMP
	jacp_[8,34] <- ((b_AKAP*(b_AKAP*k4p_4on+(1-b_AKAP)*k4p_4off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off))/kmON+((1-b_AKAP)*(b_AKAP*k4p_4on+(1-b_AKAP)*k4p_4off+b_AKAP*k3p_7on+(1-b_AKAP)*k3p_7off))/kmOFF)*RiiP
	jacp_[9,34] <- ((b_AKAP*(b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k4p_8on+(1-b_AKAP)*k4p_8off))/kmON+((1-b_AKAP)*(b_AKAP*k3p_3on+(1-b_AKAP)*k3p_3off+b_AKAP*k4p_8on+(1-b_AKAP)*k4p_8off))/kmOFF)*RiiP_cAMP
	jacp_[3,35] <- k5_1
	jacp_[5,35] <- k5_8
...
##	constants
	...
	parameters[35] <- 0.63
	parameters[37] <- 6.3
	names(parameters) <- c("k5_1", "k1_2", "k3_2", "k2_3", "k3_4", "k4_3", "k4_1", "k1_4", "k8_7", "k7_8", "k5_6", "k6_5", "k8_5", "k7_6", "k6_7", "k6_2", "k5_8", "k3p_7off", "k4p_8off", "k3p_3off", "k4p_4off", "k3p_7on", "k4p_8on", "k3p_3on", "k4p_4on", "kf_C_AKAR4", "kb_C_AKAR4", "kcat_AKARp", "kmOFF", "kmON", "KD_T", "b_AKAP", "AKAR4_ConservedConst", "CaN_ConservedConst", "Rii_C_ConservedConst", "cAMP_ConservedConst", "Rii_ConservedConst")
	return(parameters)
}
